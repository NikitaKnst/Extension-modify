...
/*chrome.pageAction.onClicked.addListener(tab => {
  chrome.tabs.executeScript(tab.id, {file: 'App/Script/Search_Clean_Color_Atribute.js'});
});*/
...
/*.addEventListener("click",ChoiseTg)*/
/*
chrome.runtime.onMessage.addListener("click",async() =>{
     var [tab] = await chrome.onMessage.query({ active: true, currentWindow: true });
   chrome.scripting.executeScript({
    target:  {tabId: tab.id, allFrames: true},
    files: ["App/Script/Search_Clean_Color_Atribute.js"],
}); 
...
{ 
  ...
  var greenId = document.getElementById("greenId").addEventListener("click",ClickGreenButten)
